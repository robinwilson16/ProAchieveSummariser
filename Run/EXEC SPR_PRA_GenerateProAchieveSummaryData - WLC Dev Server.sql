...
DECLARE @ProGeneralDatabaseLocation NVARCHAR(200) = '[wlcba-isdv001a].ProGeneral.dbo.' --Database/Linked Server location
DECLARE @ProAchieveDatabaseLocation NVARCHAR(200) = '[wlcba-isdv001a].ProAchieve.dbo.' --Database/Linked Server location
...
DECLARE @ALSStudentUserDefinedField INT = 2 --UDF where ALS is imported as Y/N
DECLARE @LookedAfterStudentUserDefinedField INT = 1
DECLARE @CareLeaverStudentUserDefinedField INT = 3
