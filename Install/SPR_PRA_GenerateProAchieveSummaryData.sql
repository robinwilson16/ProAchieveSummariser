...
BEGIN
	...
	--DECLARE @ProGeneralDatabaseLocation NVARCHAR(200) = '[IEG-MISSQL-01].ProGeneral.dbo.' --Database/Linked Server location
	--DECLARE @ProAchieveDatabaseLocation NVARCHAR(200) = '[IEG-MISSQL-01].ProAchieve.dbo.' --Database/Linked Server location
	--DECLARE @OutputTableLocation NVARCHAR(200) = 'IEG.dbo.' --Location where the resulting ProAchieve Summary Data table will be created
		...
		BEGIN
			...
			SET @SQLString = N'
				CREATE TABLE dbo.PRA_ProAchieveSummaryData(
					...
					StartYear NVARCHAR(5) NOT NULL,
					ProvisionType NVARCHAR(2) NOT NULL,
					SummaryType NVARCHAR(7) NOT NULL,
					SummaryMeasure NVARCHAR(12) NOT NULL,
					...
					PostCodeWardCode NVARCHAR(20) NULL,
					...
					DifficultyCode NVARCHAR(2) NULL,
					DifficultyName NVARCHAR(80) NULL,
					DifficultyShortName NVARCHAR(40) NULL,
					IsHighNeeds INT NULL,
					EHCPCode NVARCHAR(3) NULL,
					EHCPName NVARCHAR(100) NULL,
					EHCPShortName NVARCHAR(100) NULL,
					LearningSupportFundCode NVARCHAR(5) NULL,
					LearningSupportFundName NVARCHAR(150) NULL,
					LearningSupportFundShortName NVARCHAR(150) NULL,
			...
			SET @SQLString += 
				N'
					...
					CollegeLevel1Code NVARCHAR(24) NULL,
					CollegeLevel1Name NVARCHAR(150) NULL,
					CollegeLevel2Code NVARCHAR(24) NULL,
					CollegeLevel2Name NVARCHAR(150) NULL,
					CollegeLevel3Code NVARCHAR(24) NULL,
					CollegeLevel3Name NVARCHAR(150) NULL,
					CollegeLevel4Code NVARCHAR(24) NULL,
					...
					ProviderAimMonitoring1 NVARCHAR(20) NULL,
					ProviderAimMonitoring2 NVARCHAR(20) NULL,
					ProviderAimMonitoring3 NVARCHAR(20) NULL,
					ProviderAimMonitoring4 NVARCHAR(20) NULL,
			...
			SET @SQLString += 
				N'
					...
					NatRate_Yr_Pass INT NULL,
					NatRate_Yr_PassPer FLOAT NULL,
					...
					NatRate_YrALL_Pass INT NULL,
					NatRate_YrALL_PassPer FLOAT NULL,
					...
					NatRate_YrGFE_Pass INT NULL,
					NatRate_YrGFE_PassPer FLOAT NULL,
					...
					NatRate_Aim_Pass INT NULL,
					NatRate_Aim_PassPer FLOAT NULL,
					NatRate_Standard_Leave INT NULL,
					NatRate_Standard_Comp INT NULL,
					NatRate_Standard_RetPer FLOAT NULL,
					NatRate_Standard_Ach INT NULL,
					NatRate_Standard_AchPer FLOAT NULL,
					NatRate_Standard_Pass INT NULL,
					NatRate_Standard_PassPer FLOAT NULL,
					NatRate_FrameworkProg_Leave INT NULL,
					NatRate_FrameworkProg_Comp INT NULL,
					NatRate_FrameworkProg_RetPer FLOAT NULL,
					NatRate_FrameworkProg_Ach INT NULL,
					NatRate_FrameworkProg_AchPer FLOAT NULL,
					NatRate_FrameworkProg_Pass INT NULL,
					NatRate_FrameworkProg_PassPer FLOAT NULL,
					NatRate_Framework_Leave INT NULL,
					NatRate_Framework_Comp INT NULL,
					NatRate_Framework_RetPer FLOAT NULL,
					NatRate_Framework_Ach INT NULL,
					NatRate_Framework_AchPer FLOAT NULL,
					NatRate_Framework_Pass INT NULL,
					NatRate_Framework_PassPer FLOAT NULL,
					...
					NatRate_FworkPTSSA_Pass INT NULL,
					NatRate_FworkPTSSA_PassPer FLOAT NULL,
					...
					NatRate_Age_Pass INT NULL,
					NatRate_Age_PassPer FLOAT NULL,
					...
					NatRate_Gender_Pass INT NULL,
					NatRate_Gender_PassPer FLOAT NULL,
					...
					NatRate_GenderAge_Pass INT NULL,
					NatRate_GenderAge_PassPer FLOAT NULL,
					...
					NatRate_Level_Pass INT NULL,
					NatRate_Level_PassPer FLOAT NULL,
					...
					NatRate_LevelAge_Pass INT NULL,
					NatRate_LevelAge_PassPer FLOAT NULL,
					...
					NatRate_LevelGrp_Pass INT NULL,
					NatRate_LevelGrp_PassPer FLOAT NULL,
					...
					NatRate_LevelGrpAge_Pass INT NULL,
					NatRate_LevelGrpAge_PassPer FLOAT NULL,
					...
					NatRate_QualType_Pass INT NULL,
					NatRate_QualType_PassPer FLOAT NULL,
					...
					NatRate_QualTypeAge_Pass INT NULL,
					NatRate_QualTypeAge_PassPer FLOAT NULL,
					...
					NatRate_Ethnicity_Pass INT NULL,
					NatRate_Ethnicity_PassPer FLOAT NULL,
					...
					NatRate_EthnicityAge_Pass INT NULL,
					NatRate_EthnicityAge_PassPer FLOAT NULL,
					...
					NatRate_EthnicGroup_Pass INT NULL,
					NatRate_EthnicGroup_PassPer FLOAT NULL,
					...
					NatRate_EthnicGroupAge_Pass INT NULL,
					NatRate_EthnicGroupAge_PassPer FLOAT NULL,
					...
					NatRate_SSA1_Pass INT NULL,
					NatRate_SSA1_PassPer FLOAT NULL,
					...
					NatRate_SSA1Age_Pass INT NULL,
					NatRate_SSA1Age_PassPer FLOAT NULL,
					...
					NatRate_SSA2_Pass INT NULL,
					NatRate_SSA2_PassPer FLOAT NULL,
					...
					NatRate_SSA2Age_Pass INT NULL,
					NatRate_SSA2Age_PassPer FLOAT NULL,
					...
					NatRate_DifDis_Pass INT NULL,
					NatRate_DifDis_PassPer FLOAT NULL,
					...
					NatRate_DifDisAge_Pass INT NULL,
					NatRate_DifDisAge_PassPer FLOAT NULL
				)'
