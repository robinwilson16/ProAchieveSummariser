...
BEGIN
    ...
    SET @SQLString += 
		...
		LEFT JOIN ' + @ProAchieveDatabaseLocation + 'PG_NationalRates_CL_Qual_Overall NRG_AIMAGE
		...
		LEFT JOIN ' + @ProAchieveDatabaseLocation + 'PG_NationalRates_CL_Qual_Overall NRA_AIMAGE
