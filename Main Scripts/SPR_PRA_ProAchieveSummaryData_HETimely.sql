...
BEGIN
    ...
    SET @SQLString += 
        N'
			...
			NART_ALL_Age_Leave = NULL,
			NART_ALL_Age_RetPer = NULL,
			NART_ALL_Age_AchPer = NULL,
			NART_ALL_Age_PassPer = NULL,

			NART_GFE_Sex_Leave = NULL,
			NART_GFE_Sex_RetPer = NULL,
			NART_GFE_Sex_AchPer = NULL,
			NART_GFE_Sex_PassPer = NULL,
			NART_ALL_Sex_Leave = NULL,
			NART_ALL_Sex_RetPer = NULL,
			NART_ALL_Sex_AchPer = NULL,
			NART_ALL_Sex_PassPer = NULL,

			NART_GFE_SexAge_Leave = NULL,
			NART_GFE_SexAge_RetPer = NULL,
			NART_GFE_SexAge_AchPer = NULL,
			NART_GFE_SexAge_PassPer = NULL,
			NART_ALL_SexAge_Leave = NULL,
    ...
    SET @SQLString += 
        N'
			...
			NART_ALL_Ethnicity_Leave = NULL,
			NART_ALL_Ethnicity_RetPer = NULL,
			NART_ALL_Ethnicity_AchPer = NULL,
			...
			NART_ALL_EthnicityAge_Leave = NULL,
    ...
    SET @SQLString += 
        N'
			...
			NART_ALL_SSA1_Leave = NULL,
			NART_ALL_SSA1_RetPer = NULL,
			NART_ALL_SSA1_AchPer = NULL,
			...
			NART_ALL_SSA1Age_Leave = NULL,
			NART_ALL_SSA1Age_RetPer = NULL,
			NART_ALL_SSA1Age_AchPer = NULL,
			...
			NART_ALL_SSA2_Leave = NULL,
			NART_ALL_SSA2_RetPer = NULL,
			NART_ALL_SSA2_AchPer = NULL,
			...
			NART_ALL_SSA2Age_Leave = NULL,
			NART_ALL_SSA2Age_RetPer = NULL,
			NART_ALL_SSA2Age_AchPer = NULL,
			...
			NART_ALL_DifDis_Leave = NULL,
			NART_ALL_DifDis_RetPer = NULL,
			NART_ALL_DifDis_AchPer = NULL,
			...
			NART_ALL_DifDisAge_Leave = NULL,
			NART_ALL_DifDisAge_RetPer = NULL,
			NART_ALL_DifDisAge_AchPer = NULL,
