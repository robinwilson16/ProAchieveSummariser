		...
		BEGIN
			...
			SET @SQLString += 
				N'
					...
					NART_GFE_AimAge_Leave INT NULL,
					NART_GFE_AimAge_Comp INT NULL,
					NART_GFE_AimAge_RetPer FLOAT NULL,
					NART_GFE_AimAge_Ach INT NULL,
					NART_GFE_AimAge_AchPer FLOAT NULL,
					NART_GFE_AimAge_Pass INT NULL,
					NART_GFE_AimAge_PassPer FLOAT NULL,
					NART_ALL_AimAge_Leave INT NULL,
					NART_ALL_AimAge_Comp INT NULL,
					NART_ALL_AimAge_RetPer FLOAT NULL,
					NART_ALL_AimAge_Ach INT NULL,
					NART_ALL_AimAge_AchPer FLOAT NULL,
					NART_ALL_AimAge_Pass INT NULL,
					NART_ALL_AimAge_PassPer FLOAT NULL,
			...
			SET @SQLString += 
				N'
					...
					NART_GFE_QualTypeLevelGroup_Leave INT NULL,
					NART_GFE_QualTypeLevelGroup_RetPer FLOAT NULL,
					NART_GFE_QualTypeLevelGroup_AchPer FLOAT NULL,
					NART_GFE_QualTypeLevelGroup_PassPer FLOAT NULL,
					NART_ALL_QualTypeLevelGroup_Leave INT NULL,
					NART_ALL_QualTypeLevelGroup_RetPer FLOAT NULL,
					NART_ALL_QualTypeLevelGroup_AchPer FLOAT NULL,
					NART_ALL_QualTypeLevelGroup_PassPer FLOAT NULL,

					NART_GFE_QualTypeLevelGroupAge_Leave INT NULL,
					NART_GFE_QualTypeLevelGroupAge_RetPer FLOAT NULL,
					NART_GFE_QualTypeLevelGroupAge_AchPer FLOAT NULL,
					NART_GFE_QualTypeLevelGroupAge_PassPer FLOAT NULL,
					NART_ALL_QualTypeLevelGroupAge_Leave INT NULL,
					NART_ALL_QualTypeLevelGroupAge_RetPer FLOAT NULL,
					NART_ALL_QualTypeLevelGroupAge_AchPer FLOAT NULL,
					NART_ALL_QualTypeLevelGroupAge_PassPer FLOAT NULL,
