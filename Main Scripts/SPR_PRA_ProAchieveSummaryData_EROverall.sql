...
BEGIN
    ...
    SET @SQLString = 
		...
		SELECT
			...
			NR.BMLeave,
			NR.BMAchFrame,
			NR.BMAchFrameOverallLeave
			INTO #NARTs
		FROM ' + @ProAchieveDatabaseLocation + 'PG_NationalRates_APP_Demo_Overall NR
		WHERE
			NR.WB_HybridEndYearID = @NatRateYear
    ...
    SET @SQLString += 
        N'
			...
			StudentUserDefinedText02 = STU.UserDefined1,
			StudentUserDefinedText03 = STU.UserDefined1,
			StudentUserDefinedText04 = STU.UserDefined1,
			StudentUserDefinedText05 = STU.UserDefined1,
	...
	SET @SQLString += 
        N'
			EnrolmentUserDefinedText01 = ER.EnrolmentUserDefined1,
			EnrolmentUserDefinedText02 = ER.EnrolmentUserDefined2,
			EnrolmentUserDefinedText03 = ER.EnrolmentUserDefined3,
			EnrolmentUserDefinedText04 = ER.EnrolmentUserDefined4,
			EnrolmentUserDefinedText05 = ER.EnrolmentUserDefined5,
			EnrolmentUserDefinedNumber01 = ER.EnrolmentUserDefinedStat1,
			EnrolmentUserDefinedNumber02 = ER.EnrolmentUserDefinedStat2,
			EnrolmentUserDefinedNumber03 = ER.EnrolmentUserDefinedStat3,
			EnrolmentUserDefinedNumber04 = ER.EnrolmentUserDefinedStat4,
			EnrolmentUserDefinedNumber05 = ER.EnrolmentUserDefinedStat5,
	'
